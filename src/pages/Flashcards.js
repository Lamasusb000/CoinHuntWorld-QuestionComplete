    ...
    <div className="WidthControl50 text-dark FormStart">
        <div className="input-group mb-3">
            <div className="input-group-prepend">
                <label className="input-group-text" htmlFor="FlashCardSelection">Criteria</label>
            </div>
            <select className="custom-select" id="FlashCardSelection">
                <option disabled defaultValue="true">-- Choose an Option -- </option>
            ...
            <div className="input-group-append">
                <button id="TriviaStart" type="button" className="btn btn-primary">Start Trivia</button>
            </div>
        </div>
    </div>
    <div className="WidthControl50 text-dark FlashCard" style={{display:"none"}}>
        <div className="card">
            <div className="card-header row">
                <h5 className="col-6 mb-0">
                    Trivia Flash Cards
                </h5>
            ...
            <div className="card-body AlignCenter">
                ...
                <br/>
                <div id="TriviaAnswer" className="card-text" style={{visibility: "hidden"}}>
                    Loading...
                </div>
                <br/>
                <button id="RevealAnswer" type="button" disabled={true} className="btn btn-primary mr-2 FlashcardButton">Reveal Answer</button>
                <button id="NextQuestion" type="button" disabled={true} className="btn btn-primary FlashcardButton NextQuestion">Next Question</button>
                <button id="TriviaRestart" type="button" style={{display:"none", margin:"auto"}} className="btn btn-primary">Restart</button>
            </div>
