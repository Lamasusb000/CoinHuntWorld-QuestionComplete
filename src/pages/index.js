    ...
    return (
        <Layout>
            ...
            <div className="WidthControl50">
                ...
                <hr />
                <p className="Indent2">
                    This site is a community created tool to be used to assist
                    in your adventures on the CoinHuntWorld App! CoinHuntWorld
                    is a geolocation game where users travel around the real
                    world to places around their cities to collect keys and
                    answer questions to collect REAL Crypto!
                </p>
                <p className="Indent2">
                    Sometimes Within the game hunters recieve questions that are
                    so bizzare even Google can't help them solve it but with a
                    community sourced database hosted here any hunter can help
                    their fellow hunters solve their most complex questions with
                    a simple search from our database!
                </p>
                <p className="Indent2">
